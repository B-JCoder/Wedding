    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 px-4 bg-card">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-primary mb-6 text-balance">Contact Us</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <Card className="border-border">
                <CardHeader>
                  <CardTitle className="text-3xl font-serif text-primary">Book Your Event</CardTitle>
                ...
                <CardContent>
                  {isSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <Button type="submit" size="lg" className="w-full gold-accent text-lg py-4">
            ...
            <div className="space-y-8">
              ...
              <Card className="border-border">
                <CardHeader>
                  <CardTitle className="text-2xl font-serif text-primary">Need Immediate Help?</CardTitle>
                </CardHeader>
